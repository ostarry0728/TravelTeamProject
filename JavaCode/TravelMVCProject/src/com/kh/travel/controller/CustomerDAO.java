...
import com.kh.travel.model.CustomerVO;
...
public class CustomerDAO {
	...
	public final String CUSTOMER_UPDATE = "UPDATE CUSTOMERS SET NAME = ?, BIRTH = ?, NATIONAL = ?, GENDER = ?, EMAIL = ?, PHONE = ? WHERE NO = ?";
	public final String CUSTOMER_INSERT = "INSERT INTO CUSTOMERS VALUES (CUSTOMERS_SEQ.NEXTVAL, ?, ?, ?, ?, ?, ?, ?)";
	public final String CUSTOMER_SELECT_SORT = "SELECT * FROM CUSTOMERS ORDER BY NO";
