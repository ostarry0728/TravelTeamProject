...
BEGIN
    ...
    EXECUTE IMMEDIATE 'DROP SEQUENCE PACKAGES_SEQ';
...
Alter table PACKAGES add constraint PACKAGES_NO_PK primary key(NO);
Alter table PACKAGES add constraint PACKAGES_ID_UK UNIQUE(ID);   
Alter table PACKAGES add constraint PACKAGES_GUIDE_ID_FK 
