...
public class ReservationsAllVO {
	private int no;
	private String id;
	...
	public ReservationsAllVO() {
		super();
	}

	public ReservationsAllVO(int no, String id, String custID, String customerName, String customerEmail, String packID,
